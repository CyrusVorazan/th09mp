...
namespace th09mp {
   ...
   // Enums that list different possible values in game variables
...
#pragma pack(push, 1)
        ...
        struct Player{
            ...
            struct Vector3D rect_size1;//0x1CA8 Real size is 2 times larger
            struct Vector3D rect_size2;//0x1CB4 Real size is 2 times larger
            struct Vector3D rect_size3;//0x1CC0 Real size is 2 times larger
        ...
        struct ExFeature{
            ...
            float reisen_radius_or_aya_offset;// Radius of Udonge's EX attacks
        ...
        struct ExAttack{
            ...
            int* hitbodies;// Pointer to struct?
            struct Vector3D position;
